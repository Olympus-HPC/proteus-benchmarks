...
public: 
  ...
  /* hip Events to indicate completion of certain kernels */
  hipEvent_t time_constraint_computed;
...
void CommSendGpu(Domain& domain, Int_t msgType,
              Index_t xferFields, Domain_member *fieldData,
              Index_t dx, Index_t dy, Index_t dz,
              bool doSend, bool planeOnly, hipStream_t stream);
void CommSBNGpu(Domain& domain, Int_t xferFields, Domain_member *fieldData, hipStream_t *streams);
